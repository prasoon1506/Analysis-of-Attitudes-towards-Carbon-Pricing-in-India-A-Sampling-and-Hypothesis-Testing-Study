...
def create_visualization(region_data, region, brand, months):
    ...
    colors = ['#FF9999', 'yellowgreen', 'lightmustard', 'indianred', '#FF99CC', '#99CCFF']
    
    # Add boxes for grouping metrics
    # Box 1 for Trade
    trade_box = patches.Rectangle((0.45, 0.74), 0.47, 0.125, 
                                facecolor='#F0F0F0', 
                                edgecolor='black',
                                alpha=0.3,
    ...
    region_box = patches.Rectangle((0.45, 0.35), 0.47, 0.375,
                                 facecolor='#F0F0F0',
                                 edgecolor='black',
                                 alpha=0.3,
                                 transform=ax_current.transAxes)
    ...
    product_box = patches.Rectangle((0.45, 0.08), 0.47, 0.25,
                                  facecolor='#F0F0F0',
                                  edgecolor='black',
                                  alpha=0.3,
                                  transform=ax_current.transAxes)
