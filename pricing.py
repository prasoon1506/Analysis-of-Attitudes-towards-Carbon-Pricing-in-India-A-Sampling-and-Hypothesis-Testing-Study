...
def generate_excel_report(df):
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        for brand in selected_brands:
            ...
            focus_districts = ["Z0605_Ahmadabad", "Z0616_Surat", "Z0703_Gurugram", "Z1226_Indore", "Z1230_Balaghat", "Z1329_Nagpur", "Z1804_Sambalpur", "Z1810_Khorda","Z1909_Bathinda", "Z2013_Udaipur", "Z2020_Jaipur", "Z2405_Ghaziabad", "Z2470_Varanasi", "Z3001_East", "Z3505_Dehradun", "Z3506_Haridwar", "Z3406_Palamu", "Z3302_Raipur"]
