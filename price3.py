...
def plot_district_graph(df, district_names, benchmark_brands, desired_diff, download_stats=False,download_predictions=False, download_pdf=False):  #Updated function signature to accept a list of district names  
    ...
    for i, district_name in enumerate(district_names):  # Iterate over selected district names using enumerate
    ...
    """if download_pdf:
        pdf.close()
        display(FileLink('district_plots.pdf'))"""
    """if download_pdf:
       pdf.close()
       full_pdf_path = "/path/to/your/district_plots.pdf"  # Replace with the actual path
       display(FileLink(full_pdf_path))"""
    if download_pdf:
       pdf.close()
...
def create_interactive_plot(df):
    ...
    w = interactive(plot_district_graph, 
                    ...
                    desired_diff=fixed(desired_diff_copy), download_stats=False, download_predictions=False, download_pdf=False)
