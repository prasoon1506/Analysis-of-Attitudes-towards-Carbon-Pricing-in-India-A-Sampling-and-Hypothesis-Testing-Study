...
def main():
    ...
    with col3:
        user_date = st.text_input("Enter Date (e.g., 01 Jul)", value="01 Jul", help="Enter the date for report generation")
