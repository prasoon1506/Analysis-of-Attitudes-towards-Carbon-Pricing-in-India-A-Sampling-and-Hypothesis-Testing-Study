...
def main():
    ...
    with col3:
        user_date = st.text_input("Enter Date (e.g., 01 Aug)", value="01 Aug", help="Enter the date for report generation")
